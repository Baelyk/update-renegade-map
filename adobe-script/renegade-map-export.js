/* global activeDocument, ExportType, File */
...
activeDocument.exportFile(new File('~/Downloads/RIAMap.svg'), ExportType.SVG)

/* Export political png */
activeDocument.exportFile(new File('~/Downloads/political.png'), ExportType.PNG24)

/* Export politicalnames png */
activeDocument.layers.getByName('Political Map').visible = true
activeDocument.exportFile(new File('~/Downloads/politicalnames.png'), ExportType.PNG24)
